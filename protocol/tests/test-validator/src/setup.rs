...
use solana_sdk::{commitment_config::CommitmentConfig, pubkey::Pubkey, rent::Rent, signature::Keypair, sysvar::SysvarId};
...
pub fn setup() -> TestContext {
    ...
    let rent_account = client.get_account(&Rent::id()).expect("failed to get rent account");
